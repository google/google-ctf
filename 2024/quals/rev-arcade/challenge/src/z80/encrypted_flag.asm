...
; A previous iteration of this challenge involved inputting the flag as an input combo,
; users would do UP + A and that outputs a char. This iteration got deprecated in favour of
; the current one released to users, because it ended up more guessy that we anticipated.
    org $cafe
EncryptedFlag:
