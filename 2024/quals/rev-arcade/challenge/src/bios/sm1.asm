...
.loop:
    ...
    ; $01 means to prepare for switching to the Cartridge's sound driver. A real implementation would stop all sound here.
    cp		$01
    jr		z,PrepareSwitch
...
; Some messages for people doing "strings".
