...
class Portal(generics.GenericObject):
    ...
    def tick(self):
        super().tick
        self.red_timer = max(0, self.red_timer - 1)
    ...
    def on_player_collision(self, player):
        ...
        if self.game.tics % 3 < 2 and self.game.has_item("portal"):
            self.red_timer = 120
            player.dead = True
            return
    ...
    def get_draw_info(self):
        ...
        if self.visible:
            ...
            if self.red_timer == 0:
                ...
                return [gfx.circle_filled(
                    self.x + r, self.y - r, r * 1.2, (255,255,255,255)
                ), gfx.circle_outline(
                    self.x + r, self.y - r, r * 1.2, (255,0,0,255), border_width=5
                )]
        else:
            ret = []
