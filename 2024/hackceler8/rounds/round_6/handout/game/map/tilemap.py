...
from game.components.stateful import Crops, Soil
import xxhash
...
def init_coins():
    return [
        Coin("base", 544, 2720, "gp"), Coin("base", 2320, 4112, "vn"),
        Coin("beach", 5376, 288, "wj"), Coin("beach", 3568, 496, "ye"),
        Coin("ruins", 1072, 2128, "ru"), Coin("ruins", 560, 2080, "fm"),
        Coin("cloud", 3392, 2288, "dv"), Coin("fighting", 1120, 368, "fv"),
        Coin("ocean", 3936, 3712, "yk"), Coin("ocean", 2640, 1008, "gh"),
    ]
