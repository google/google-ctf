...
class Warp(generics.GenericObject):
    ...
    def __init__(self, coords, name):
        ...
        self.rnd = random.Random(self.map_name)
        super().__init__(
    ...
    def tick(self):
        if "boss" not in self.map_name and self.game.has_item("random_gate"):
            self.map_name = self.rnd.choice(["base", "beach", "ruins", "cloud", "ocean"])
        super().tick()
