...
class ProjectileSystem:
    ...
    def _check_player_collisions(self, pressed_keys):
        if self.game.has_item("fleeing"):
            for o in self.weapons:
                if o.expand(30).collides(self.game.player):
                    sign = 1 if self.game.player.x < o.x else -1
                    o.move(sign * self.game.player.base_x_speed * 1.1, 0)
