...
def init_coins():
    return [
        Coin("base", 1760, 2512, "cs"), Coin("base", 1584, 2960, "mh"),
        Coin("beach", 3440, 1152, "ir"), Coin("beach", 2000, 544, "yi"),
        Coin("ruins", 192, 1168, "rp"),  Coin("ruins", 560, 2080, "fm"),
        Coin("cloud", 560, 4208, "uj"), Coin("cloud", 1056, 3760, "wy"),
        Coin("ocean", 400, 1824, "zi"), Coin("ocean", 3616, 1808, "eb"),
    ]
