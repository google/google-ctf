...
class PhysicsEngine:
    ...
    def tick(self):
        ...
        if self.player.spikes != 0:
            self.player.decrease_health(1, "wall_spikes")
    ...
    def check_something(self, t):
        if t.name == "wells" and self.game.ashek.check() == "tock":
