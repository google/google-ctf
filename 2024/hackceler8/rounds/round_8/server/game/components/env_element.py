...
ZERO_G_MODIFIER = EnvModifier("zero_g", 0.5, 0.5, 0, False)
WELLS_ENV = EnvModifier("wells", 2.0, 1, -10, False)

modifiers = {
    "water": WATER_MODIFIER, "cloud_1": CLOUD_MODIFIER_1,
    "cloud_2": CLOUD_MODIFIER_2, "cloud_3": CLOUD_MODIFIER_3, "zero_g": ZERO_G_MODIFIER, "wells":WELLS_ENV
}
