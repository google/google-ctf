...
utils.deterministicRandom = h_list => {
    h_list[0] = Math.imul(h_list[0] ^ h_list[0] >>> 16, 2246822507)
    h_list[0] = Math.imul(h_list[0] ^ h_list[0] >>> 13, 3266489909)
    return (h_list[0] ^= h_list[0] >>> 16) >>> 0
}
