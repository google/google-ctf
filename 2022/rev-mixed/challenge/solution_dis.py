...
from solution_opcode import *
from solution_opcode import __all__ as _opcodes_all
from solution_opcode import _nb_ops, _inline_cache_entries, _specializations, _specialized_instructions
