...
from components import arena, duck
...
class BasicTileMap:
    ...
    def parse_object(self, o, max_y):
        ...
        if o.name == "Fire":
            ...
            self.dynamic_artifacts.append(fountain.OneTimeFountain(coords, o.size, min_distance=md, benefit=bft))
            ...
            logging.debug(o)
            logging.debug(o.properties)
            l = logic.parse_logic(o.properties, coords, self.logic_map,
                                  getattr(o, "points", None))
            if l is not None:
