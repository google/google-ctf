do
   local function some_string_obfusc(v24,v25)
      local v26=0
      local v27
      while true do
         if (v26==1) then
         ...
         if (v26==0) then
            v27={}
            for v44=1, #v24 do
               table.insert(v27,string.char(bit32.bxor(string.byte(string.sub(v24,v44,v44 + 1 )),string.byte(string.sub(v25,1 + ((v44-1)% #v25) ,1 + ((v44-1)% #v25) + 1 )))%256 ))
            end
            v26=1
         end
      end
   end
   local v8=_G[some_string_obfusc("\79\15\131\30\40\13\20\203","\59\96\237\107\69\111\113\185")]
   local v9=_G[some_string_obfusc("\55\2\190\232\63\247","\68\118\204\129\81\144\122")][some_string_obfusc("\12\180\100\225","\110\205\16\132\107\85\33\139")]
   local v10=_G[some_string_obfusc("\243\205\101\215\89\95","\128\185\23\190\55\56\100")][some_string_obfusc("\240\94\174\46","\147\54\207\92\126\115\131")]
   local v11=_G[some_string_obfusc("\109\25\35\60\115\10","\30\109\81\85\29\109")][some_string_obfusc("\239\234\115","\156\159\17\52\214\86\190")]
   local v12=_G[some_string_obfusc("\175\186\253\180\178\169","\220\206\143\221")][some_string_obfusc("\213\149\104\47","\178\230\29\77\119\184\172")]
   local v13=_G[some_string_obfusc("\235\225\172\3\21\112","\152\149\222\106\123\23")][some_string_obfusc("\167\216\54","\213\189\70\150\35")]
   local v14=_G[some_string_obfusc("\28\78\87\120\13","\104\47\53\20")][some_string_obfusc("\12\172\66\130\29\168","\111\195\44\225\124\220")]
   local v15=_G[some_string_obfusc("\191\217\68\12\118","\203\184\38\96\19\203")][some_string_obfusc("\199\55\96\124\83\218","\174\89\19\25\33")]
   local v16=_G[some_string_obfusc("\6\46\6\90","\107\79\114\50\46\151\231")][some_string_obfusc("\204\61\163\173\57","\160\89\198\213\73\234\89\215")]
   local v17=_G[some_string_obfusc("\194\77\101\178\251\203\94","\165\40\17\212\158")] or function()
   return _ENV
end

local v18=_G[some_string_obfusc("\53\224\205\5\54\50\228\205\9\49\42\224","\70\133\185\104\83")]
local v19=_G[some_string_obfusc("\217\7\68\72\38","\169\100\37\36\74")]
local v20=_G[some_string_obfusc("\67\5\139\167\83\20","\48\96\231\194")]
local v21=_G[some_string_obfusc("\150\198\74\15\46\18","\227\168\58\110\77\121\184\207")] or _G[some_string_obfusc("\177\122\62\179\69","\197\27\92\223\32\209\187\17")][some_string_obfusc("\238\13\79\194\248\8","\155\99\63\163")]
local v22=_G[some_string_obfusc("\144\141\223\180\128\187\129\144","\228\226\177\193\237\217")]
      ...
      if (v30==3) then
                                                                                                               ...
                                                                                                               while true do
                                                                                                                  ...
                                                                                                                  if (1==v243) then
                                                                                                                     ...
                                                                                                                     while true do
                                                                                                                        if (v310==0) then
                                                                                                                           v246={}
                                                                                                                           v245=v18({},{[some_string_obfusc("\99\44\165\136\88\22\180","\60\115\204\230")]=function(v346,v347)
                                                                                                                           local v348=0
                                                                                                                           local v349
                                                                                                                           local v350
                                                                                                                           while true do
                                                                                                                           ...
                                                                                                                           end,[some_string_obfusc("\79\216\52\238\103\238\52\239\117\255","\16\135\90\139")]=function(v351,v352,v353)
                                                                                                                           local v354=0
                                                                                                                           local v355
                                                                                                                           local v356
                                                                                                                           while true do
                                                                     ...
                                                                     if (v181==1) then
                                                                        while true do
                                                                           if (0==v182) then
                                                                              ...
                                                                              error(some_string_obfusc("\75\87\102\15\35\90\20\125\70\102\9\33\14\85\108\20\79","\24\52\20\102\83\46\52")   .. v183   .. some_string_obfusc("\50\158","\111\164\79\65\68")   .. _G['A'][2 + 0 ] )
                                                                              break
                                                                           end
                                                                        end
                                                                        break
         ...
         if (v45==1) then
            if (v31==0) then
               ...
               while true do
                  if (v52==1) then
                     v28=v12(v11(v28,5),some_string_obfusc("\168\122","\134\84\208\67"),function(v86)
