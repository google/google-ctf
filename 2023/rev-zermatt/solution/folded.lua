                                             ...
                                             if (v66==1) then
                                                      ...
                                                      local v162
                                                            ...
                                                            v162=nil
                                                                                 ...
                                                                                 while true do -- might be real while
                                                                                                ...
                                                                                                if (v194<=14) then
                                                                                                   if (v194<=(6)) then
                                                                                                      if (v194<=(2)) then
                                                                                                         ...
                                                                                                         else v191[v193[2 ]]=v191[v193[3 ]] -v193[4 ]
                                                                                                         end
                                                                                                      elseif (v194<=(4)) then
                                                                                                         if (v194==(3)) then
                                                                                                            v158=v193[3 ]
                                                                                             ...
                                                                                             elseif (v194<=(21)) then
                                                                                                if (v194<=(17)) then
                                                                                                   ...
                                                                                                   else v64[v193[3 ]]=v191[v193[2 ]]
                                                                                                   end
                                                                                                elseif (v194<=19) then
                                                                                                   if (v194>(18)) then
                                                                                                      v191[v193[2]]=v191[v193[3 ]]%v191[v193[4]]
                                                                                                   else v191[v193[2 ]]= #v191[v193[3]]
                                                                                                   end
                                                                                                elseif (v194>(20)) then
                                                                                                   local v271
                                                                                                   local v272
                                                               ...
                                                               else return table.unpack(_G['A'],2 ,_G['B'])
                                                               end
                                          end
                                       end
                                       break
