...
const BOSS_HEALTH_BAR_X: u16 = 7;
const BOSS_HEALTH_BAR_Y: u16 = 4;
...
impl UI {
    pub fn new(res_state: &mut State, vdp: &mut TargetVdp) -> Self {
        UI {
            ...
            render_state: RenderState::new(WorldType::Overworld),
        }
    }
    ...
    pub fn maybe_clear(&mut self, world: &World) {
        if self.render_state.world_type != world.world_type {
