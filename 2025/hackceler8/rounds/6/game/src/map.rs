...
type AttrLayer = Array2d<'static, u16>;
...
pub struct Map {
    ...
    tiles_idx: usize,
    pub gfx_layer: GfxLayer,
    pub attr_layer: AttrLayer,
    palette: Palette,
...
impl Map {
    ...
    pub fn set_gfx_layer(&mut self, gfx_layer: GfxLayer) {
        self.gfx_layer = gfx_layer;
    }
