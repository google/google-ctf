...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let sprite_list = [
        ...
        (
            resources_root().join("sprites/items/staff.tsx"),
            &GamePalette::Player.global(),
        ),
        (
            resources_root().join("sprites/items/pencil.tsx"),
            &GamePalette::Player.global(),
        ),
        (
        ...
        (
            resources_root().join("sprites/fake-flame.tsx"),
            &GamePalette::Enemy.for_world("boss-temple"),
        ),
        (
            resources_root().join("sprites/flame.tsx"),
            &GamePalette::Enemy.for_world("boss-temple"),
        ),
        (
