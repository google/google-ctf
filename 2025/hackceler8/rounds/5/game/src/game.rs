...
pub struct Game<C: Controllers, R: Renderer, V: Vdp, P: Portal> {
    ...
    pub boss_dialogue: boss::BossDialogue,
}
...
impl Game<TargetControllers, TargetRenderer, TargetVdp, TargetPortal> {
    ...
    pub fn new(
        ...
        let (starting_world, inventory_data) = Self::load_persistent_state(&portal);

        crate::res::palettes::load_world_palette(starting_world, &mut vdp);
        ...
        let ui = UI::new(&mut res_state, &mut vdp, starting_world);
        ...
        let mut game = Game {
            ...
            win_scene: None,
            boss_dialogue: boss::BossDialogue::new(),
        };
        game.load_inventory_data(&inventory_data);
        game
    }
